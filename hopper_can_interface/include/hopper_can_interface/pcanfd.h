...
#include "hopper_can_interface/pcan.h" //#include "pcan.h"
#include <sys/time.h>  // just added this because "error: field ‘timestamp’ has incomplete type ‘timeval’" -bbokser
