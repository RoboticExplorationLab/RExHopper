...
#include <GL/glu.h>
    ...
    !defined(__gles2_gl3_h_) && !defined(__gles2_gl31_h_) && !defined(__gles2_gl32_h_) && !defined(__gl_glcorearb_h_) &&                  \
    !defined(__gl2_h_) /*legacy*/ && !defined(__gl3_h_) /*legacy*/ && !defined(__gl31_h_) /*legacy*/ && !defined(__gl32_h_) /*legacy*/ && \
    !defined(__glcorearb_h_) /*legacy*/ && !defined(__GL_H__) /*non-standard*/ && !defined(__gltypes_h_) /*non-standard*/ &&              \
 ...
 * X](https://developer.apple.com/library/mac/documentation/GraphicsAnimation/Conceptual/HighResolutionOSX/Explained/Explained.html) in the
 * Mac Developer Library.  The GLFW test and example programs use a custom `Info.plist` template for this, which can be found as
 ...
 *  @ingroup vulkan
 */
GLFWAPI VkResult glfwCreateWindowSurface(VkInstance instance, GLFWwindow* window, const VkAllocationCallbacks* allocator,
